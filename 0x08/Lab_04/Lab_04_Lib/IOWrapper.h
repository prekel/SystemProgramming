/// \file
/// \brief Обёртки над низкоуровнеными функциями ввода-вывода
/// \details Обёртки над низкоуровнеными функциями для работы с вводом-выводом
/// и файловыми дескрипторами для совместимости под различные платформы и
/// компиляторы.
