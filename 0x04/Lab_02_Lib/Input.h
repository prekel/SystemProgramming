...
/*! \brief Считывает строку
 *
 *  \details Считывает строку до перевода строки.
 *
...
/*! \brief Считывает целое число с проверкой
 *
 *  \details Выводит выходную фразу и считывает целое число. Если из считанной
