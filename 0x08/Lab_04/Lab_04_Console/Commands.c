...
#define APP_NAME "Lab_04_Console"
#define HELP_SEP ": "
#define HELP_SUFFIX "\n"

#define HELP_MESSAGE \
"Использование: ./" APP_NAME " команда [" DEFAULT_USAGES "] [опции...]" HELP_SUFFIX \
"Команды: " HELP_SUFFIX \
ADD_COMMAND_NAME HELP_SEP ADD_COMMAND_DESCRIPTION HELP_SUFFIX \
MODIFY_COMMAND_NAME HELP_SEP MODIFY_COMMAND_DESCRIPTION HELP_SUFFIX \
REMOVE_COMMAND_NAME HELP_SEP REMOVE_COMMAND_DESCRIPTION HELP_SUFFIX \
CREATE_COMMAND_NAME HELP_SEP CREATE_COMMAND_DESCRIPTION HELP_SUFFIX \
...
"Опции: " HELP_SUFFIX \
OPT_FILENAME_USAGE HELP_SEP OPT_FILENAME_DESCRIPTION HELP_SUFFIX \
OPT_RECREATE_USAGE HELP_SEP OPT_RECREATE_DESCRIPTION HELP_SUFFIX \
OPT_OPEN_OR_CREATE_USAGE HELP_SEP OPT_OPEN_OR_CREATE_DESCRIPTION HELP_SUFFIX \
OPT_META_FORMAT_USAGE HELP_SEP OPT_META_FORMAT_DESCRIPTION HELP_SUFFIX \
OPT_FORMAT_USAGE HELP_SEP OPT_FORMAT_DESCRIPTION HELP_SUFFIX \
OPT_COUNT_FORMAT_USAGE HELP_SEP OPT_COUNT_FORMAT_DESCRIPTION HELP_SUFFIX \
OPT_HEXDUMP_USAGE HELP_SEP OPT_HEXDUMP_DESCRIPTION HELP_SUFFIX \
OPT_PRINT_USAGE HELP_SEP OPT_PRINT_DESCRIPTION HELP_SUFFIX \
OPT_HELP_USAGE HELP_SEP OPT_HELP_DESCRIPTION HELP_SUFFIX \
OPT_NAME_USAGE HELP_SEP OPT_NAME_DESCRIPTION HELP_SUFFIX \
OPT_COUNT_ISLANDS_USAGE HELP_SEP OPT_COUNT_ISLANDS_DESCRIPTION HELP_SUFFIX \
OPT_COUNT_INHABITED_ISLANDS_USAGE HELP_SEP OPT_COUNT_INHABITED_ISLANDS_DESCRIPTION HELP_SUFFIX \
OPT_OLD_NAME_USAGE HELP_SEP OPT_OLD_NAME_DESCRIPTION HELP_SUFFIX \
OPT_INDEX_USAGE HELP_SEP OPT_INDEX_DESCRIPTION HELP_SUFFIX \
OPT_REMOVE_SWAP_WITH_LAST_USAGE HELP_SEP OPT_REMOVE_SWAP_WITH_LAST_DESCRIPTION HELP_SUFFIX \
OPT_OR_USAGE HELP_SEP OPT_OR_DESCRIPTION HELP_SUFFIX \
