...
typedef struct
{
    ...
    /// Строка форматирования для вывода метаинформции. Если не дана, по умолчанию DEFAULT_META_FORMAT.
    char* MetaFormat;

    /// Дана ли строка форматирования для записи (архипелага).
    bool IsFormatGiven;
    /// Строка форматирования для записи (архипелага). Если не дана, по умолчанию DEFAULT_FORMAT
    char* Format;

    /// Дана ли строка форматирования кол-ва выведенных записей.
    bool IsCountFormatGiven;
    /// Строка форматирования кол-ва выведенных записей. Если не дана, по умолчанию DEFAULT_COUNT_FORMAT
    char* CountFormat;
    ...
    /// Требуется ли при удалении архипелага их файла записать последний архпелаг на место удаляемого.
